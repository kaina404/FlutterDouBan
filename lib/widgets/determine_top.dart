...
class DetermineTopState extends State<DetermineTop> with TickerProviderStateMixin<DetermineTop> {
  ...
  bool _handleScrollNotification(ScrollNotification notification) {
    ...
    if (indicatorAtTopNow != _isIndicatorAtTop) {
      ...
      if (_mode == RefreshIndicatorMode.armed && notification.dragDetails == null) {
  ...
  void _checkDragOffset(double containerExtent) {
    assert(_mode == RefreshIndicatorMode.drag || _mode == RefreshIndicatorMode.armed);
  ...
  void _dismiss(RefreshIndicatorMode newMode)  {
    assert(newMode == RefreshIndicatorMode.canceled || newMode == RefreshIndicatorMode.done);
    _mode = newMode;
